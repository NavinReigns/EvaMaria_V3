...
async def next_page(bot, query):
    ...
    btn.insert(0,
        [
            InlineKeyboardButton(text="⚡ʜᴏᴡ ᴛᴏ ᴅᴏᴡɴʟᴏᴀᴅ⚡", url='https://t.me/jvn_tutorials/25')
        ]
    )
    btn.insert(1,
        [
            InlineKeyboardButton(text="⚙️This site can't be reached⚙️", url='https://t.me/Jvn_Tutorials/17')
        ]
    )
